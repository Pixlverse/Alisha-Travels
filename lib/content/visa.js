 ...
 *
 * The tourist visa page has its own copy file, ./tourist-visa.js, because
 * its 197-destination table would swamp this one.
 *
...
export const HUB = {
  ...
  ctas: {
    situations: {
      title: "Not sure which visa it is?",
      text: "Tell us who's travelling and where. We'll tell you which visa it is, and what the file needs before you pay a fee.",
...
export const DEPENDANT = {
  ...
  ctas: {
    situations: {
      title: "Not sure if your family can apply?",
      text: "Tell us the sponsor's visa, their employer and when they arrived. We check the route is open for your family before you pay anything.",
      primary: "Check eligibility",
    },
    docs: {
      title: "Want the list for your family?",
      text: "A document list for every family member, for your route, with every name and date checked against the sponsor's paperwork.",
      primary: "Get our document list",
    },
  },
  meta: {
...
export const SETTLEMENT = {
  ...
  ctas: {
    situations: {
      title: "Not sure where you are on the road to settlement?",
      text: "Tell us your partner's status in the UK, their income and when you married. We check the numbers before you pay the fee.",
      primary: "Check my case",
    },
    docs: {
      title: "Want us to check both halves of your file?",
      text: "The sponsor's documents from the UK and yours from India, matched line by line before anything is submitted.",
      primary: "Check my documents",
    },
  },
  meta: {
