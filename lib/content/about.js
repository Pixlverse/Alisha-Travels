 ...
 *
 *  1. ELAPSED-YEAR COUNTS HAVE BEEN REPLACED WITH "Since 2013", at the
 *     client's instruction. The source copy said "thirteen years" in the hero
 *     and "twelve" / "more than twelve" in sections 1 and 8, which disagreed
 *     with each other and went stale every January. A founding year does
 *     neither. Do not reintroduce a year count here or anywhere else.
 *
...
export const ABOUT_SECTIONS = {
  opening: {
    ...
    close: "Since 2013, that has been our job.",
  },
  ...
  team: {
    ...
    body: [
      "Across our Google reviews, our travellers keep naming the individual who looked after them. The one who rebuilt an itinerary around a toddler's nap times, who found seats at impossible notice, who answered the phone from Srinagar, who checked in mid-trip just to confirm the hotel was right.",
  ...
  proof: {
    ...
    body: [
      ...
      "Since 2013. Thousands of departures. Corporate groups of a hundred and more. A 4.8 on Google and 4.9 on JustDial, earned one traveller at a time.",
    ],
    close:
