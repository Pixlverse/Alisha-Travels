...
export const RESOURCES = {
  destinations: {
    ...
    fields: [
...

      {
        ...
        rows: 6,
        section: "Content",
        help: "The opening, before the first section. Leave a blank line between paragraphs.",
      },
      {
        name: "blocks",
        label: "Page sections",
        ...
        itemLabel: "Section",
        help:
          "The body of the page, in order. Choose the kind that matches what you have written: a bulleted list, a grid of named cards, or plain paragraphs. A section with a heading and nothing else acts as a heading for the sections under it.",
        of: [
          {
            name: "kind",
            label: "Kind",
          ...
          { name: "intro", label: "Lead paragraph", type: "textarea", rows: 2 },
          { name: "body", label: "Paragraphs", type: "textarea", rows: 5 },
          { name: "points", label: "Bullets (list)", type: "stringList" },
          {
            name: "items",
            label: "Cards",
            type: "objectList",
          ...
          { name: "footnote", label: "Closing line", type: "textarea", rows: 2 },
        ],
      },
      {
        name: "closingTitle",
        ...
        type: "text",
        section: "Content",
        help: 'The last line of the page - "Ready to plan your Kerala holiday?"',
      },
      { name: "closingText", label: "Sign-off text", type: "textarea", rows: 4, section: "Content" },

      {
        ...
        rows: 5,
        section: "Content",
        help: "Ignored on pages that use the sections above.",
      },
      {
  ...
  categoryPages: {
    model: CategoryPage,
    label: "Package page",
    plural: "Package pages",
    description:
      "The copy that sits around a package category listing - /packages/honeymoon/, /packages/family/ and /packages/group-tours/. The packages themselves are edited under Packages; this is the page they sit inside. A category with no entry here keeps the plain heading-and-grid layout.",
    defaultSort: { slug: 1 },
    listColumns: [
      { key: "title", label: "Title", primary: true },
      { key: "slug", label: "Category" },
      { key: "status", label: "Status", format: "status" },
    ],
    searchFields: ["title", "slug"],
    previewPath: (doc) => `/packages/${doc.slug}/`,
    fields: [
      {
        ...
        required: true,
        section: "Basics",
        help: "Which category listing this page wraps. One entry per category.",
        options: PACKAGE_CATEGORIES.map((category) => ({
          value: category.slug,
          label: category.label,
        })),
      },
      { name: "title", label: "Page heading", type: "text", required: true, section: "Basics" },
      { name: "eyebrow", label: "Eyebrow", type: "text", section: "Basics" },
      {
        name: "heroLead",
      ...
      },
      {
        ...
        rows: 2,
        section: "Basics",
        help: "The smaller line carrying the credentials.",
      },
      { name: "ctaLabel", label: "Button label", type: "text", section: "Basics" },
      {
...

      {
        ...
        section: "Content",
        itemLabel: "Promise",
        help: "The row of short cards under the heading. Four fits the grid exactly.",
        of: [
          { name: "title", label: "Heading", type: "text", required: true },
          { name: "text", label: "Line under it", type: "text" },
        ],
      },
      {
        name: "intro",
        ...
        rows: 6,
        section: "Content",
        help: "Sits above the package grid. Leave a blank line between paragraphs.",
      },
      {
        name: "blocks",
      ...
      { name: "closingText", label: "Sign-off text", type: "textarea", rows: 3, section: "Content" },
